...
app.get('/api/jogos', async (req, res) => {
    try {
        ...
        // Timeout aumentado para garantir resposta
        ...
        // Se não tiver jogos hoje, pega os próximos
...
function formatar(data) {
    return data.map(j => {
        // --- ALTERAÇÃO AQUI: FORÇA BRUTA ---
        // Antes verificava status. Agora é sempre TRUE para você ver funcionando.
        const ativo = true; 
